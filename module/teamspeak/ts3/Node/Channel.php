 ...
 *
 * $Id: Channel.php 2010-01-18 21:54:35 sven $
 * 
...
class TeamSpeak3_Node_Channel extends TeamSpeak3_Node_Abstract
{
  ...
  /**
   * Moves the channel to the parent channel specified with $cpid.
   *
   * @param  integer $cpid
   * @param  integer $order
   * @return void
   */
  public function move($cpid, $order = null)
  {
    $this->getParent()->channelMove($this->getId(), $cpid, $order);
  }
